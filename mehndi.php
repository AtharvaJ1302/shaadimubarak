  ...
  <section id="container">
        ...
        <div class="card front">
          <div id="carouselExampleControls1" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              ...
              <div class="carousel-item">
                <img src="mehndi/im1.jpg" class="d-block w-100" alt="..." width="538px" height="358px">
              </div>
            </div>
	...
	<div class="card front">
          <div id="carouselExampleControls3" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="mehndi/img3.jpg" class="d-block w-100" alt="..." width="538px" height="358px">
              </div>
              <div class="carousel-item">
                <img src="mehndi/b3.jpg" class="d-block w-100" alt="..." width="538px" height="358px">
              </div>
              <div class="carousel-item">
                <img src="mehndi/im3.jpg" class="d-block w-100" alt="..." width="538px" height="358px">
              </div>
            </div>
    ...
    <label class="col-md-5 card-container" for='card-4'>
        <div class="card front">
          <div id="carouselExampleControls4" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="mehndi/img4.jpg" class="d-block w-100" alt="..." width="538px" height="358px">
              </div>
              <div class="carousel-item">
                <img src="mehndi/b4.jpg" class="d-block w-100" alt="..." width="538px" height="358px">
              </div>
              <div class="carousel-item">
                <img src="mehndi/im4.jpg" class="d-block w-100" alt="..." width="538px" height="358px">
              </div>
            </div>
    ...
    <label class="col-md-5 card-container" for='card-5'>
        <div class="card front">
          <div id="carouselExampleControls5" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="mehndi/img5.jpg" class="d-block w-100" alt="..." width="538px" height="358px">
              </div>
              <div class="carousel-item">
    ...
    <label class="col-md-5 card-container" for='card-6'>
        <div class="card front">
          <div id="carouselExampleControls6" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="mehndi/img6.jpg" class="d-block w-100" alt="..." width="538px" height="358px" width="538px" height="358px" width="538px" height="358px">
              </div>
              <div class="carousel-item">
                <img src="mehndi/b6.jpg" class="d-block w-100" alt="..." width="538px" height="358px" width="538px" height="358px" width="538px" height="358px">
              </div>
              <div class="carousel-item">
                <img src="mehndi/im6.jpg" class="d-block w-100" alt="..." width="538px" height="358px" width="538px" height="358px" width="538px" height="358px">
              </div>
            </div>
        ...
        <div class="card front">
          <div id="carouselExampleControls7" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              ...
              <div class="carousel-item">
                <img src="mehndi/b7.jpg" class="d-block w-100" alt="..." width="538px" height="358px" width="538px" height="358px">
              </div>
              <div class="carousel-item">
        ...
        <div class="card front">
          <div id="carouselExampleControls8" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              ...
              <div class="carousel-item">
                <img src="mehndi/im8.jpg" class="d-block w-100" alt="..." width="538px" height="358px">
              </div>
            </div>
        ...
        <div class="card front">
          <div id="carouselExampleControls9" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              ...
              <div class="carousel-item">
                <img src="mehndi/b9.jpg" class="d-block w-100" alt="..." width="538px" height="358px">
              </div>
              <div class="carousel-item">
