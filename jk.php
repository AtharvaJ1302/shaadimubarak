        ...
        <div class="card back">
          ...
          <div class="card-block">
            ...
            <div class="price" style="top:8rem;" >₹91000</div>
             <button class="btn btn-primary" name="venue1" style="top: 6.5rem;">Select</button>
          </div>
        </div>
        <!-- End Card 1 Back -->
      </div>
        ...
        <div class="card back">
          ...
          <div class="card-block">
            ...
            <div class="price" style="top:4rem;" >₹98000</div>
             <button class="btn btn-primary" name="venue5" style="top: 2rem;">Select</button>
          </div>
        </div>
        <!-- End Card 5 Back -->
      </div>
        ...
        <div class="card back">
          ...
          <div class="card-block">
            ...
            <div class="price" style="top:4rem;" >₹120000</div>
             <button class="btn btn-primary" name="venue6" style="top: 2rem;">Select</button>
          </div>
        </div>
        <!-- End Card 6 Back -->
      </div>
