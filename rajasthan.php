      ...
      <div class="card-flip">
        ...
        <div class="card back">
          ...
          <div class="card-block">
            ...
            <button class="btn btn-primary" name="venue2" style="top: 6.5rem;">Select</button>
          </div>
        </div>
        <!-- End Card 2 Back -->
      </div>
      ...
      <div class="card-flip">
        ...
        <div class="card back">
          ...
          <div class="card-block">
            ...
            <div class="price" style="top: 8.5rem;">$500</div>
            <button class="btn btn-primary" name="venue4" style="top: 6.5rem;">Select</button>
          </div>
        </div>
        <!-- End Card 4 Back -->
      </div>
      ...
      <div class="card-flip">
        ...
        <div class="card back">
          ...
          <div class="card-block">
            ...
            <button class="btn btn-primary" name="venue5" style="top: 8rem;">Select</button>
          </div>
        </div>
        <!-- End Card 5 Back -->
      </div>
      ...
      <div class="card-flip">
        ...
        <div class="card back">
          ...
          <div class="card-block">
            ...
            <button class="btn btn-primary" name="venue8" style="top: 7rem;">Select</button>
          </div>
        </div>
        <!-- End Card 8 Back -->
      </div>
      ...
      <div class="card-flip">
        ...
        <div class="card back">
          ...
          <div class="card-block">
            ...
            <div class="price" style="top: 10rem;">$500</div>
            <button class="btn btn-primary" name="venue9" style="top: 8rem;">Select</button>
          </div>
        </div>
        <!-- End Card 9 Back -->
      </div>
      ...
      <div class="card-flip">
        ...
        <div class="card back">
          ...
          <div class="card-block">
            ...
            <button class="btn btn-primary" name="venue10" style="top: 11rem;">Select</button>
          </div>
        </div>
        <!-- End Card 10 Back -->
      </div>
